...
그림 5는 인터뷰 데이터에서 찾은 요인을 대표하는 일기 연구 동안 참가자들이 보고한 **다양한 해시태그**를 보여줍니다. 위에서 설명한 프레임에서 발생한 사건을 분석함으로써 특정 요인이 다른 요인보다 일부 context 프레임에서 더 문제가 있거나 영향력이 있음을 발견했습니다. 즉, 이러한 요인은 다른 설정에서 다른 영향을 미쳤고 위에서 설명한 context 프레임은 이러한 차이를 모델링하는 데 도움이 됩니다.  
...
따라서, 참가자들은 당뇨병을 관리하는 상황적 프레임에 따라 당뇨병을 관리하는 정도를 달리하거나 완전히 포기했습니다.
